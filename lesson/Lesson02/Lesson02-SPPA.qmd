...
Reference: [11.2 From Maps to Models: Defining Spatial Patterns Statistically](https://mgimond.github.io/Spatial/11_intro_spatial.html#from-maps-to-models-defining-spatial-patterns-statistically)
:::
...
- [14  First-Order Point Pattern Analysis](https://mgimond.github.io/Spatial/14_ppa_1st.html) and [15  Second-Order Point Pattern Analysis](https://mgimond.github.io/Spatial/15_ppa_2nd.html) of **Introduction to GIS and Spatial Analysis**.

- GIS&T Body of Knowledge [AM-07-Point Pattern Analysis](https://gistbok-ltb.ucgis.org/page/current/concept/AM-03-007)

- GIS&T Body of Knowledge [AM-08-Kernels and Density Estimation](https://gistbok-ltb.ucgis.org/page/current/concept/AM-03-008)
