...
- [spNetwork](https://cran.r-project.org/web/packages/spNetwork/index.html)
  - [spNetwork: A Package for Network Kernel Density Estimation](https://journal.r-project.org/articles/RJ-2021-102/index.html), R Journal, 2021, Vol. 13/2
  - [spNetwork: A R package to perform spatial analysis on networks](https://jeremygelb.github.io/spNetwork/)
